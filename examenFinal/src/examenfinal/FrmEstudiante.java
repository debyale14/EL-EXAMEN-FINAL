...
public class FrmEstudiante extends javax.swing.JFrame {
   ...
   public void actualizar(){
        try{ 
            ...
            "SELECT id,nombre,carrera FROM estudiantes;"
            );
    ...
    private void initComponents() {
        ...
        jScrollPane3.setViewportView(TabEstudiantes);
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        try {
            String sql = "INSERT INTO estudiantes (nombre, id, carrera) VALUES ('"
                         +nombre.getText()+"','"+id.getText()+"','"+carrera.getText()+"');";
            CBaseDatos con = new CBaseDatos();
